...
namespace CardSortDeskTop.Pages
{
    ...
    /// </summary>
    public sealed partial class TransferCards : Page
    {
        ...
        private void DeckBox1_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
        ...
        private void DeckBox2_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
        ...
        private void ToDeck2Button_Click(object sender, RoutedEventArgs e)
        {

        }

        private void ToDeck1Button_Click(object sender, RoutedEventArgs e)
        {
